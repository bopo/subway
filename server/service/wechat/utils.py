...
from .plugins.setting import plugin_text as PLUGINS

# from django.conf import settings

# DEFAULT_TIMEOUT = settings.DEFAULT_TIMEOUT  # 15 * 60
...
def text_response(recv_msg, content):
    ...
    return render_to_response('response/msg_text.xml', {'msg': msg, })
...
def pic_text_response(recv_msg, msg_item):
    ...
    return render_to_response('response/msg_pic_text.xml', {'msg': msg, })


def article_response(recv_msg, msg_item):
    return pic_text_response(recv_msg, msg_item)
